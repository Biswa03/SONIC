...
const Banner = ({data}) => {
  return (
    <div className="min-h-[550px] flex justify-center items-center py-12  ml-5 mr-5 ">
      ...
      <div className="container">
        ...
        className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center text-white rounded-3xl">
            ...
            <div data-aos="zoom-in" className="h-full flex items-center">
                <img src={data.image} className="scale-125 w-[250px] md:w-[340px] mx-auto drop-shadow-2xl object-cover"/>
            </div>
            {/* THIRD COL */}
            <div className="flex flex-col justify-center gap-4 p-6 sm:p-8">
                ...
                className="bg-white py-2 px-4 w-[125px]  rounded-full">Shop Now</button>
            </div>
        </div>
      </div>
    </div>
